...
if __name__ == '__main__':
    ...
    d = dw.react_to_message(data.API_GET("id"), data.API_GET("channel_id"), "🟩")
    d2 = dw.react_to_message(data.API_GET("id"), data.API_GET("channel_id"), "🟥")
    print(data)
    print(d)
    print(d2)

    d3 = dw.create_thread_from_message(data.API_GET("id"), data.API_GET("channel_id"), "Discussion")
    print(d3)
